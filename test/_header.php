...
<div class="container mt-5">
    <div class="row">
        <div class="col">
            <a href="https://github.com/lee-ratinan/currencyFormatLocalizer" class="btn btn-warning" target="_blank">
            ...
            <a class="btn btn-outline-secondary" href="config.php">Config</a>
        </div>
    </div>
</div>